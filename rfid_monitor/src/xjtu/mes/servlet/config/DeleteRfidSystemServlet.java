...
* 类说明
*/
@WebServlet("/DeleteRfidSystemServlet")
public class DeleteRfidSystemServlet extends HttpServlet {
	/**
	 * 
	 */
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(RfidSystemManager.getInstance().deleteRfidSystemByRfidId(rfidId)){
