    ...
    $.fn.tableExport = function (options) {
        ...
        this.each(function () {
            ...
            function checkCaption(exportButton) {
                ...
                //当存在caption元素时，会在其内部进行追加，导致每调用一次该函数就会添加一个按钮，改成覆盖式。当没有caption就新建一个。
                ...
                $caption.length ? $caption.html(exportButton)  : $el.prepend('<caption class="' + bootstrapSpacing + settings.position + '">' + exportButton + '</caption>');
            }
