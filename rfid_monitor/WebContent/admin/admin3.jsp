...
<%
	...
	if(user.getUserId().equals("admin")){
		...
		workpieces = WorkpieceManager.getInstance().getWorkpiecesByDifferentNameAndUserId(user.getUserId());  
	}
								...
								<!-- PAGE CONTENT BEGINS -->
									...
									<div class="row">
										...
										<div class="col-sm-12">
											...
											<!-- <h1>1 零件</h1> -->
											<p class="lead">
										 	&nbsp  &nbsp &nbsp &nbsp&nbsp &nbsp此次统计主要统计该机床下，零件及工序的进度情况。
											</p>
										...
										<div class ="row" >
											...
											<div   class="col-xs-8 col-xs-offset-1 col-md-2 col-md-offset-3">
												<div class="row">
												<label class="label label-xlg label-primary arrowed arrowed-right">请选择机床</label>
							...
							<div class="col-xs-12">
								...
								<div class="row">
									...
									<div class="col-sm-12">
										<!-- <h1>1 零件</h1> -->
										<p class="lead">
										 &nbsp  &nbsp &nbsp &nbsp&nbsp &nbsp当前用户的零件完成情况及同类零件的完成情况。
										</p>
									</div><!-- /span -->
									<!-- 选择区 -->
									<div class="row">
